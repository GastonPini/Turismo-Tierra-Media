...
<head>
<meta charset="UTF-8">
<title>Compra Promociones</title>
<script
	...
	<div class="mx-auto col-sm-13 main-section" id="myTab" role="tablist">
		<ul class="nav nav-tabs justify-content-end">
			<li class="nav-item"><a class="nav-link active" id="list-tab"
				...
				aria-selected="false">Lista Promociones</a></li>
		</ul>
			...
			<div class="tab-pane fade show active" id="list" role="tabpanel"
				...
				<div class="card">
					<div class="card-header">
						<h4>Listado de promociones en la tierra media.</h4>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<table id="atracciones"
								...
								<tbody>
									<c:forEach items="${promociones}" var="p">
										<tr>
											<td><c:out value="${p.nombre}" /></td>
											<td><c:out value="${p.tipo}" /></td>
											<td><c:out value="${p.activo}" /></td>
											<td><c:out value="${p.datoExtra}" /></td>
											<td><a href="#">Comprar <i class="fas fa-edit"></i>
											</a></td>
										</tr>
									</c:forEach>
								</tbody>
